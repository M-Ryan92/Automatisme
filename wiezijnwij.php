<html>
	<head>
		<title>Rijschool Automatisme - Wie zijn wij</title>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					<img src="img/JosVerwillegen.jpg" class="thumbnail col-md-2">
					<div class="col-md-8">
			...
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					<img src="img/MikeKoster.jpg" class="thumbnail col-md-2">
					<div class="col-md-8">
						<h4>Mike Koster</h4>
			...
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					<img src="img/RijschoolIcon.png" class="thumbnail col-md-2"></img>
					<div class="col-md-8">
						<h4>De rijschool</h4>
